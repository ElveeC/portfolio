import styles from "./ViteIcon.module.scss";
import cn from "classnames";

const ViteIcon = ({ inView }) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="url(#paint0_linear_307_184)"
      />
      <path
        ...
        fill="url(#paint1_linear_307_184)"
      />
      <defs>
        <linearGradient
          id="paint0_linear_307_184"
          x1="26.3459"
          y1="44.075"
          x2="143.127"
          y2="202.673"
        ...
        >
          <stop className={cn(styles['icon__color'], styles['icon__color--1'])} stopColor="currentColor" />
          <stop className={cn(styles['icon__color'], styles['icon__color--2'])} offset="1" stopColor="currentColor" />
        </linearGradient>
        <linearGradient
          id="paint1_linear_307_184"
          x1="122.551"
          y1="31.7433"
          x2="143.676"
          y2="176.66"
          gradientUnits="userSpaceOnUse"
        >
          <stop className={cn(styles['icon__color'], styles['icon__color--3'])} stopColor="currentColor" />
          <stop className={cn(styles['icon__color'], styles['icon__color--4'])} offset="0.0833333" stopColor="currentColor" />
          <stop className={cn(styles['icon__color'], styles['icon__color--5'])} offset="1" stopColor="currentColor" />
        </linearGradient>
      </defs>
    </svg>
  );
